...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      const response = await api.get<ServerResponse>('/transactions');
      const {
        balance: balanceData,
        transactions: transactionsData,
      } = response.data;

      const formattedBalanceData: Balance = {
      ...
      const formattedTransactionsData: Transaction[] = transactionsData.map(
        transaction => {
          return {
            ...transaction,
      ...
      setBalance(formattedBalanceData);
